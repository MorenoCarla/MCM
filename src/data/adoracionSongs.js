/** Repertorio de Adoración y categorías relacionadas — coro MCM */
export const ADORACION_SONGS = [
  {
    id: 'silencio-fecundo',
...
Silencio fecundo para los dos
           ...
           D        G
Para abandonarme en ti
       D             G
Abandonarme en tu regazo
      Em  D      G
Y renovar mi corazón
     Bm D         G
...
Volver al presente
        Em  D      G
Y disfrutar de tu luz
      Bm        D      G
Disfrutar de esta soledad
...
Y permanecer en tu amor
        Bm    D     G
Permanecer en ti Jesús
 
         D               G
Para sufrir mirando tu cruz
    D               G
Sufrir cargando la mía
   Em     D       G
Y amar, amarte Jesús
  Bm      D         G
Amarme como me amas Tú
...
Ten piedad, Ten piedad, Ten piedad`,
  },
  {
    ...
    body: `[Intro] B  C#m  B  F#  D#m  B  C#m
  
F#                     B
Ojala tuviera mas que darte
     D#m            C#
Pero solo mi vida tengo
      B         Bm          F#  D#m
Y ya no, pues es tuya para ti
       G#m7          C#      F#
Vivela tu, pues es tuya para ti
 
          B             F#
No es mas fácil porque sufro
          G#m7          C#
Es mas fácil porque soy feliz
 
 
      F#          D#m            B    C#m
Si vivire hasta morir, quiero vivir amando
        A#m      B
Hasta morir, de amor
       E       C#
Y eternamente amar
...
Como responder a tanto amor
       D#m                C#
Si no con mi pequeño corazón
        B           Bm        F#   D#m
Que no quiere latir, si no para ti
         B           C#m
Pues yo soy para mi amado y mi amado
         F#
Es para mi
...
No es mas fácil
              F#
Debo hacerme pequeño
     G#m7
Es mas fácil
                  C#
Solo aquí yo soy pleno
 
 
      F#         D#m            B     C#m
Si viviré hasta morir, quiero vivir amando
          A#m      B
Hasta morir, de amor
B             C#            B
...
Por favor deja de decir
                     C
Que no eres amada por mi`,
  },
  {
    id: 'con-el-corazon',
    title: 'Con el corazón',
    key: 'C',
    placements: [{ categoryId: 'adoracion', momentId: '' }],
    body: `C                            G
Jesús, aquí me tienes a tu lado
F                       C
Lleno de certezas, pero lleno de dudas
F                       C
Lleno de verdades, pero lleno de preguntas
             G                     F
Y aunque se bien, que ese es mi pecado
Am                    G
No me dejes solo, necesito de tu mano
  
C                           G
Ayúdame a pensar con el corazón
       Am                  F
A entregarme a vos, a entregarme a vos
C                          G
Préstame tus redes, quiero ser un pescador
     Am         F
Como vos, como vos
C                               G
No me dejes solo, quiero estar siempre junto a vos
        Am           F
Junto a vos, junto a vos
C                           G
Muéstrame el camino, muéstrame tu perfección
        Am        F
...
Lleno de verdades, pero lleno de preguntas
            G              F
Y aunque se bien, que necesito una señal
         Am
No quiero ser como Tomás
           F                           G
Que tuvo que ver para creer que aquí estás
...
por siempre te amo, y siempre te amaré.`,
  },
  {
    ...
    placements: [{ categoryId: 'adoracion', momentId: '' }],
    body: ` D                                G
Miras al frente y no sabes dónde vas
                                    D
...
¡Tranquilo!
              G                          D
Que no estás solo siempre hay alguien contigo
              A                 Bm
Y que en sus brazos te carga rendido
           G                    D        A
Te vuelves más ligero si te abandonas en mi
 
       Bm
No te agites
           G                            D
Cierra los ojos, abre el alma y ven conmigo
         A                          Bm
Soy tu refugio, tu resguardo, y tu amigo
       G                    D        A
En mi palabra sabrás donde está el camino
...
E                                  G#m           
Verte en lo pequeño y saber que me hiciste para 
      F#
algo inmenso
E                                  B        
...
Corazones sedientos de paz`,
  ...
  {
    id: 'declaracion-a-domicilio',
    title: 'Declaración a domicilio',
    key: 'D',
...
Pero qué al tercer día volvería`,
  },
  {
    ...
    title: 'Maria y Juan',
    key: 'C',
    placements: [{ categoryId: 'maria', momentId: '' }],
    body: `C                      G                   Am
Entre gritos de dolor equivocados
        F                 Dm7                  G
Y el llanto de algunos desconsolados
          F                  G           E7/G         Am
Contemplaba a mi hijo en esa cruz clavado
         Dm7                F                  G
Más allá de no tener ningún pecado
No sabia por que me pasaba
Si sabia que mucho me dolía
Ver sufrir a aquel que yo más quería
Sentir el alma por la espada traspasada
               F               G                   Am
Pero en medio de tanto sufrimiento
            Dm7              Em7           F
Mi hijo Dios, en su último suspiro
          Dm7                 F               G
Poco antes de entregar el aliento
             Dm7                  G                 C
Me hizo madre de su tan amado amigo
C    F      C


No fue fácil responder a ese llamado
De seguirlo por el resto de mis días
Pero fue el sentirme tan amado
Lo que me llevó a darle mi vida

No pude dejar de mirar el madero
Al que su vida tuvo que entregar
En sus ojos, un silencio tan sincero
Que decían, "amigo, que bueno que aquí estás"

Y en el gran momento de la verdad
Olvidándose de aquello que le dolía
